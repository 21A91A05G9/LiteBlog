...
export default function Like(props) {
  ...
  const toggle = () => {
     ...
     axios.get('https://lite-blog-nine.vercel.app/getId', { params: {title: newBlogData.title} }).then((res) => {  
      setId(res.data.id);
      console.log("blogdata id is", id);
      if (id !== undefined) {
        axios.put('https://lite-blog-nine.vercel.app/updateblog/' + id, newBlogData)
          .then((res) => {
